...
const ownervb = process.env.OWNERS || process.env.OWNER_NUMBER || '254116266407' ; // put your number here
...
global.pairingNumber = process.env.BOT_NUMBER || '254116266407' ;  // put your number here
